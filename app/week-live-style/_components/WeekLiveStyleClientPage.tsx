...
},
{
  ...
  image: "https://img.rocket.new/generatedImages/rocket_gen_img_128405646-1767103756538.png",
            ...
            {categories?.map((category) => {
              ...
              return (
                <Button
                  ...
                  className={
                  category?.slug === "all" ? "bg-gradient-to-r from-[#FF9AA2] to-[#FFB7B2] hover:from-[#FF8A92] hover:to-[#FFA7A2] text-white border-0" : "border-slate-200 hover:bg-slate-50"
                  }
