...
function ReservarContent() {
  ...
  const [selectedWeek, setSelectedWeek] = useState(weekParam ? Number.parseInt(weekParam) : 1)
  ...
  const getWeekDates = (weekNum: number) => {
    ...
    return {
      start: startDate.toLocaleDateString("es-MX", { day: "numeric", month: "short" }),
      end: endDate.toLocaleDateString("es-MX", { day: "numeric", month: "short", year: "numeric" }),
    }
  }
  ...
  const steps = [
    { num: 1, label: "Semana", icon: Calendar },
    { num: 2, label: "Datos", icon: Briefcase },
    { num: 3, label: "Pago", icon: CreditCard },
    { num: 4, label: "Escrow", icon: Shield },
    { num: 5, label: "Voucher", icon: Check },
  ]
...
export default function MonterreyUrbanReservarPage() {
  return (
