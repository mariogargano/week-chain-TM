    ...
    <div className="min-h-screen bg-gradient-to-b from-pink-50 via-white to-pink-50">
      ...
      <section className="relative py-20 sm:py-32 overflow-hidden">
        ...
        <div className="relative">
          <div className="absolute inset-0 z-50 bg-slate-900/90 backdrop-blur-sm flex items-start justify-center pt-32">
            <div className="max-w-2xl mx-auto text-center px-6">
              <div className="mb-8">
                <Heart className="w-16 h-16 text-[#FF9AA2] mx-auto mb-6 animate-pulse fill-current" />
              </div>
              ...
              <p className="text-xl sm:text-2xl text-slate-300 mb-8 leading-relaxed">
                WEEK Fundación y el programa WEEK-CARE estarán activos pronto
              </p>
              ...
              <p className="mt-10 text-sm text-slate-400">WEEK Fundación™ estará disponible próximamente</p>
            </div>
          </div>
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div>
                  ...
                  <p className="text-lg text-slate-600 mb-6 leading-relaxed">
                    ...
                    familias que perdieron sus hogares. Cada familia recibirá no solo una casa, sino también
                    capacitación en oficios y apoyo para la autosuficiencia.
                  </p>
