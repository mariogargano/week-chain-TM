        ...
        <div className="max-w-7xl mx-auto space-y-8">
          <div>
            <h1 className="text-4xl font-bold bg-gradient-to-r from-purple-600 via-pink-600 to-rose-600 bg-clip-text text-transparent">
              Aprobación Final de Propiedades
            </h1>
            <p className="text-slate-600 mt-2">Revisa y aprueba propiedades verificadas por notarios</p>
          </div>
          ...
          <div className="flex gap-2">
            ...
            <Button
              ...
              className={filter === "approved" ? "bg-gradient-to-r from-purple-500 to-pink-500" : ""}
            >
              Aprobadas
            </Button>
          </div>
                ...
                >
                  <CardContent className="p-6">
                    <div className="flex items-start gap-6">
                      <div className="h-24 w-24 rounded-lg bg-gradient-to-br from-green-100 to-emerald-100 flex items-center justify-center flex-shrink-0">
                      ...
                      <div className="flex-1">
                        <div className="flex items-start justify-between mb-4">
                          <div>
                            ...
                            <Badge className="bg-green-100 text-green-700 mt-2">Aprobado por Notario</Badge>
                          </div>
                          {submission.admin_reviewed_at && (
                            <Badge
                              className={
            ...
            <Card className="border-purple-200/50 bg-white/90 backdrop-blur-xl shadow-lg">
              <CardContent className="flex min-h-[200px] items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-slate-600">No hay propiedades para aprobar</p>
                </div>
              </CardContent>
            </Card>
          )}
