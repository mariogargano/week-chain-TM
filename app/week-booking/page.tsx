...
import { MapPin, Building2, Shield, Clock, CheckCircle2, ArrowRight, BarChart3, Info, FileText } from "lucide-react"
        ...
        <section className="px-4 sm:px-6 py-16 sm:py-24 bg-gradient-to-br from-slate-50 to-white">
          <div className="container mx-auto max-w-6xl">
            <div className="flex items-center justify-between mb-8">
              <div>
                <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 mb-2">Ejemplos de Solicitudes Posibles</h2>
        ...
        <section className="px-4 sm:px-6 py-16 sm:py-24 bg-white">
          <div className="container mx-auto max-w-6xl">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-slate-600">Proceso de solicitud de uso temporal - NO es reserva garantizada</p>
            </div>
